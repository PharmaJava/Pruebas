...
Leer el `SKILL.md` correspondiente ANTES de empezar cualquier tarea del tipo indicado.

| Skill | Trigger — cuándo leerla |
|---|---|
| `skills/nomina-js/SKILL.md` | Cualquier cálculo en app.js: nómina, finiquito, IT, horas, trienios, SS, IRPF |
| `skills/seo-farmacia/SKILL.md` | Tocar index.html: meta tags, headings, FAQs, keywords, estructura |
| `skills/deploy-check/SKILL.md` | Antes de cada deploy y si algo falla en producción |
| `skills/schema-faq/SKILL.md` | Añadir/modificar FAQs o datos estructurados JSON-LD |
| `skills/prisma-nominafarmacia/SKILL.md` | Cualquier migración o cambio de schema en el backend nominafarmacia |
